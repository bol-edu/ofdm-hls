...
#
# composable_communcation.tcl: Tcl script for re-creating project 'composable_communcation'
#
# Generated by Vivado on Tue Mar 07 20:18:17 CST 2023
...
#
# 1. This project restoration tcl script (composable_communcation.tcl) that was generated.
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set paths [list \
 "[file normalize "$origin_dir/[file normalize "$origin_dir/vitis_hls_composable_project/CP/CP_insertion/prj_impulse_test.prj"]"]"\
 "[file normalize "$origin_dir/[file normalize "$origin_dir/vitis_hls_composable_project/sym_pixl/pixl2sym/prj_impulse_test.prj"]"]"\
 "[file normalize "$origin_dir/[file normalize "$origin_dir/vitis_hls_composable_project/CP/CP_removal/prj_impulse_test.prj"]"]"\
 "[file normalize "$origin_dir/[file normalize "$origin_dir/vitis_hls_composable_project/pilot/pilot_insertion/prj_impulse_test.prj"]"]"\
 "[file normalize "$origin_dir/[file normalize "$origin_dir/vitis_hls_composable_project/sym_pixl/sym2pixl/prj_impulse_test.prj"]"]"\
 "[file normalize "$origin_dir/[file normalize "$origin_dir/vitis_hls_composable_project/pilot/pilot_removal/prj_impulse_test.prj"]"]"\
 "[file normalize "$origin_dir/[file normalize "$origin_dir/vitis_hls_composable_project/channel/prj_impulse_test.prj"]"]"\
 "[file normalize "$origin_dir/[file normalize "$origin_dir/vitis_hls_composable_project/QAM/deQAM/prj_impulse_test.prj"]"]"\
 "[file normalize "$origin_dir/[file normalize "$origin_dir/vitis_hls_composable_project/QAM/QAM/prj_impulse_test.prj"]"]"\
 "[file normalize "$origin_dir/[file normalize "$origin_dir/vitis_hls_composable_project/FFT/IFFT/prj_impulse_test.prj"]"]"\
 "[file normalize "$origin_dir/[file normalize "$origin_dir/vitis_hls_composable_project/FFT/FFT/prj_impulse_test.prj"]"]"\
 "[file normalize "$origin_dir/[file normalize "$origin_dir/vitis_hls_composable_project/ECC/encoder/prj_impulse_test.prj"]"]"\
 "[file normalize "$origin_dir/[file normalize "$origin_dir/vitis_hls_composable_project/ECC/decoder/prj_impulse_test.prj"]"]"\
 "[file normalize "$origin_dir/[file normalize "$origin_dir/vitis_hls_composable_project/QAM_RTL_tcl/QAM_RTL_IP"]"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "composable_communcation"
...
set script_file "composable_communcation.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/composable_communcation"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/vitis_hls_composable_project/CP/CP_insertion/prj_impulse_test.prj"] [file normalize "$origin_dir/vitis_hls_composable_project/sym_pixl/pixl2sym/prj_impulse_test.prj"] [file normalize "$origin_dir/vitis_hls_composable_project/CP/CP_removal/prj_impulse_test.prj"] [file normalize "$origin_dir/vitis_hls_composable_project/pilot/pilot_insertion/prj_impulse_test.prj"] [file normalize "$origin_dir/vitis_hls_composable_project/sym_pixl/sym2pixl/prj_impulse_test.prj"] [file normalize "$origin_dir/vitis_hls_composable_project/pilot/pilot_removal/prj_impulse_test.prj"] [file normalize "$origin_dir/vitis_hls_composable_project/channel/prj_impulse_test.prj"] [file normalize "$origin_dir/vitis_hls_composable_project/QAM/deQAM/prj_impulse_test.prj"] [file normalize "$origin_dir/vitis_hls_composable_project/QAM/QAM/prj_impulse_test.prj"] [file normalize "$origin_dir/vitis_hls_composable_project/FFT/IFFT/prj_impulse_test.prj"] [file normalize "$origin_dir/vitis_hls_composable_project/FFT/FFT/prj_impulse_test.prj"] [file normalize "$origin_dir/vitis_hls_composable_project/ECC/encoder/prj_impulse_test.prj"] [file normalize "$origin_dir/vitis_hls_composable_project/ECC/decoder/prj_impulse_test.prj"] [file normalize "$origin_dir/vitis_hls_composable_project/QAM_RTL_tcl/QAM_RTL_IP"]" $obj
...
set_property -name "top" -value "commun_wrapper" -objects $obj
...
# Proc to create BD commun
proc cr_bd_commun { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name commun
  ...
  xilinx.com:hls:CP_insertion:2.0\
  xilinx.com:hls:CP_removal:2.0\
  xilinx.com:hls:QAM:2.0\
  HLSNIS:user:QAM:1.0\
  xilinx.com:ip:axis_switch:1.1\
  xilinx.com:hls:channel_gen:2.0\
  xilinx.com:hls:deQAM:2.0\
  xilinx.com:hls:decoder:2.0\
  xilinx.com:hls:encoder:2.0\
  xilinx.com:hls:equalizer_pilot_removal:2.0\
  xilinx.com:hls:fft_top0:2.0\
  xilinx.com:hls:fft_top1:2.0\
  xilinx.com:hls:pilot_insertion:2.0\
  xilinx.com:hls:pixl_to_symbol:2.0\
  xilinx.com:hls:symbol_to_pixl:2.0\
  "
...
# Hierarchical cell: comm
proc create_hier_cell_comm { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_comm() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: CP_insertion_0, and set properties
  set CP_insertion_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:CP_insertion:2.0 CP_insertion_0 ]

  # Create instance: CP_removal_0, and set properties
  set CP_removal_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:CP_removal:2.0 CP_removal_0 ]

  # Create instance: QAM_0, and set properties
  set QAM_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:QAM:2.0 QAM_0 ]

  # Create instance: QAM_1, and set properties
  set QAM_1 [ create_bd_cell -type ip -vlnv HLSNIS:user:QAM:1.0 QAM_1 ]
  ...
  # Create instance: channel_gen_0, and set properties
  set channel_gen_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:channel_gen:2.0 channel_gen_0 ]

  # Create instance: deQAM_0, and set properties
  set deQAM_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:deQAM:2.0 deQAM_0 ]

  # Create instance: decoder_0, and set properties
  set decoder_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:decoder:2.0 decoder_0 ]

  # Create instance: encoder_0, and set properties
  set encoder_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:encoder:2.0 encoder_0 ]

  # Create instance: equalizer_pilot_remo_0, and set properties
  set equalizer_pilot_remo_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:equalizer_pilot_removal:2.0 equalizer_pilot_remo_0 ]

  # Create instance: fft_top0_0, and set properties
  set fft_top0_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:fft_top0:2.0 fft_top0_0 ]

  # Create instance: fft_top1_0, and set properties
  set fft_top1_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:fft_top1:2.0 fft_top1_0 ]

  # Create instance: pilot_insertion_0, and set properties
  set pilot_insertion_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:pilot_insertion:2.0 pilot_insertion_0 ]

  # Create instance: pixl_to_symbol_0, and set properties
  set pixl_to_symbol_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:pixl_to_symbol:2.0 pixl_to_symbol_0 ]

  # Create instance: symbol_to_pixl_0, and set properties
  set symbol_to_pixl_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:symbol_to_pixl:2.0 symbol_to_pixl_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net CP_insertion_0_data_out [get_bd_intf_pins CP_insertion_0/data_out] [get_bd_intf_pins axis_switch/S05_AXIS]
  connect_bd_intf_net -intf_net CP_removal_0_data_out [get_bd_intf_pins CP_removal_0/data_out] [get_bd_intf_pins axis_switch/S10_AXIS]
  connect_bd_intf_net -intf_net QAM_0_data_out [get_bd_intf_pins QAM_0/data_out] [get_bd_intf_pins axis_switch/S06_AXIS]
  connect_bd_intf_net -intf_net QAM_1_m_axis [get_bd_intf_pins QAM_1/m_axis] [get_bd_intf_pins axis_switch/S07_AXIS]
  connect_bd_intf_net -intf_net axi_dma_M_AXIS_MM2S [get_bd_intf_pins S03_AXIS] [get_bd_intf_pins axis_switch/S03_AXIS]
  connect_bd_intf_net -intf_net axis_switch_0_M01_AXIS [get_bd_intf_pins M01_AXIS] [get_bd_intf_pins axis_switch/M01_AXIS]
  connect_bd_intf_net -intf_net axis_switch_M00_AXIS [get_bd_intf_pins axis_switch/M00_AXIS] [get_bd_intf_pins pixl_to_symbol_0/data_in]
  connect_bd_intf_net -intf_net axis_switch_M02_AXIS [get_bd_intf_pins axis_switch/M02_AXIS] [get_bd_intf_pins encoder_0/data_in]
  connect_bd_intf_net -intf_net axis_switch_M03_AXIS [get_bd_intf_pins axis_switch/M03_AXIS] [get_bd_intf_pins pilot_insertion_0/data_in]
  connect_bd_intf_net -intf_net axis_switch_M04_AXIS [get_bd_intf_pins axis_switch/M04_AXIS] [get_bd_intf_pins fft_top0_0/data_in]
  connect_bd_intf_net -intf_net axis_switch_M05_AXIS [get_bd_intf_pins CP_insertion_0/data_in] [get_bd_intf_pins axis_switch/M05_AXIS]
  connect_bd_intf_net -intf_net axis_switch_M06_AXIS [get_bd_intf_pins QAM_0/data_in] [get_bd_intf_pins axis_switch/M06_AXIS]
  connect_bd_intf_net -intf_net axis_switch_M07_AXIS [get_bd_intf_pins QAM_1/s_axis] [get_bd_intf_pins axis_switch/M07_AXIS]
  connect_bd_intf_net -intf_net axis_switch_M08_AXIS [get_bd_intf_pins axis_switch/M08_AXIS] [get_bd_intf_pins channel_gen_0/data_in]
  connect_bd_intf_net -intf_net axis_switch_M09_AXIS [get_bd_intf_pins axis_switch/M09_AXIS] [get_bd_intf_pins deQAM_0/data_in]
  connect_bd_intf_net -intf_net axis_switch_M10_AXIS [get_bd_intf_pins CP_removal_0/data_in] [get_bd_intf_pins axis_switch/M10_AXIS]
  connect_bd_intf_net -intf_net axis_switch_M12_AXIS [get_bd_intf_pins axis_switch/M12_AXIS] [get_bd_intf_pins fft_top1_0/data_in]
  connect_bd_intf_net -intf_net axis_switch_M13_AXIS [get_bd_intf_pins axis_switch/M13_AXIS] [get_bd_intf_pins equalizer_pilot_remo_0/data_in]
  connect_bd_intf_net -intf_net axis_switch_M14_AXIS [get_bd_intf_pins axis_switch/M14_AXIS] [get_bd_intf_pins decoder_0/data_in]
  connect_bd_intf_net -intf_net axis_switch_M15_AXIS [get_bd_intf_pins axis_switch/M15_AXIS] [get_bd_intf_pins symbol_to_pixl_0/data_in]
  connect_bd_intf_net -intf_net channel_gen_0_data_out [get_bd_intf_pins axis_switch/S08_AXIS] [get_bd_intf_pins channel_gen_0/data_out]
  connect_bd_intf_net -intf_net deQAM_0_data_out [get_bd_intf_pins axis_switch/S09_AXIS] [get_bd_intf_pins deQAM_0/data_out]
  connect_bd_intf_net -intf_net decoder_0_data_out [get_bd_intf_pins axis_switch/S14_AXIS] [get_bd_intf_pins decoder_0/data_out]
  connect_bd_intf_net -intf_net encoder_0_data_out [get_bd_intf_pins axis_switch/S01_AXIS] [get_bd_intf_pins encoder_0/data_out]
  connect_bd_intf_net -intf_net equalizer_pilot_remo_0_data_out [get_bd_intf_pins axis_switch/S13_AXIS] [get_bd_intf_pins equalizer_pilot_remo_0/data_out]
  connect_bd_intf_net -intf_net fft_top0_0_data_out [get_bd_intf_pins axis_switch/S04_AXIS] [get_bd_intf_pins fft_top0_0/data_out]
  connect_bd_intf_net -intf_net fft_top1_0_data_out [get_bd_intf_pins axis_switch/S12_AXIS] [get_bd_intf_pins fft_top1_0/data_out]
  connect_bd_intf_net -intf_net pilot_insertion_0_data_out [get_bd_intf_pins axis_switch/S02_AXIS] [get_bd_intf_pins pilot_insertion_0/data_out]
  connect_bd_intf_net -intf_net pixl_to_symbol_0_data_out [get_bd_intf_pins axis_switch/S00_AXIS] [get_bd_intf_pins pixl_to_symbol_0/data_out]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins S_AXI_CTRL] [get_bd_intf_pins axis_switch/S_AXI_CTRL]
  connect_bd_intf_net -intf_net symbol_to_pixl_0_data_out [get_bd_intf_pins axis_switch/S15_AXIS] [get_bd_intf_pins symbol_to_pixl_0/data_out]

  # Create port connections
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins s_axi_ctrl_aresetn] [get_bd_pins CP_insertion_0/ap_rst_n] [get_bd_pins CP_removal_0/ap_rst_n] [get_bd_pins QAM_0/ap_rst_n] [get_bd_pins QAM_1/axi_reset_n] [get_bd_pins axis_switch/aresetn] [get_bd_pins axis_switch/s_axi_ctrl_aresetn] [get_bd_pins channel_gen_0/ap_rst_n] [get_bd_pins deQAM_0/ap_rst_n] [get_bd_pins decoder_0/ap_rst_n] [get_bd_pins encoder_0/ap_rst_n] [get_bd_pins equalizer_pilot_remo_0/ap_rst_n] [get_bd_pins fft_top0_0/ap_rst_n] [get_bd_pins fft_top1_0/ap_rst_n] [get_bd_pins pilot_insertion_0/ap_rst_n] [get_bd_pins pixl_to_symbol_0/ap_rst_n] [get_bd_pins symbol_to_pixl_0/ap_rst_n]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins s_axi_ctrl_aclk] [get_bd_pins CP_insertion_0/ap_clk] [get_bd_pins CP_removal_0/ap_clk] [get_bd_pins QAM_0/ap_clk] [get_bd_pins QAM_1/axi_clk] [get_bd_pins axis_switch/aclk] [get_bd_pins axis_switch/s_axi_ctrl_aclk] [get_bd_pins channel_gen_0/ap_clk] [get_bd_pins deQAM_0/ap_clk] [get_bd_pins decoder_0/ap_clk] [get_bd_pins encoder_0/ap_clk] [get_bd_pins equalizer_pilot_remo_0/ap_clk] [get_bd_pins fft_top0_0/ap_clk] [get_bd_pins fft_top1_0/ap_clk] [get_bd_pins pilot_insertion_0/ap_clk] [get_bd_pins pixl_to_symbol_0/ap_clk] [get_bd_pins symbol_to_pixl_0/ap_clk]

  # Perform GUI Layout
  regenerate_bd_layout -hierarchy [get_bd_cells /comm] -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"0.96318",
   "Default View_TopLeft":"-38,-26",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port M01_AXIS -pg 1 -lvl 3 -x 1130 -y 1010 -defaultsOSRD
preplace port S03_AXIS -pg 1 -lvl 0 -x 0 -y 1940 -defaultsOSRD
preplace port S_AXI_CTRL -pg 1 -lvl 0 -x 0 -y 2100 -defaultsOSRD
preplace port port-id_s_axi_ctrl_aclk -pg 1 -lvl 0 -x 0 -y 90 -defaultsOSRD
preplace port port-id_s_axi_ctrl_aresetn -pg 1 -lvl 0 -x 0 -y 110 -defaultsOSRD
preplace inst CP_insertion_0 -pg 1 -lvl 1 -x 420 -y 90 -defaultsOSRD
preplace inst CP_removal_0 -pg 1 -lvl 1 -x 420 -y 880 -defaultsOSRD
preplace inst QAM_0 -pg 1 -lvl 1 -x 420 -y 250 -defaultsOSRD
preplace inst axis_switch -pg 1 -lvl 2 -x 860 -y 1140 -defaultsOSRD
preplace inst channel_gen_0 -pg 1 -lvl 1 -x 420 -y 720 -defaultsOSRD
preplace inst deQAM_0 -pg 1 -lvl 1 -x 420 -y 1040 -defaultsOSRD
preplace inst decoder_0 -pg 1 -lvl 1 -x 420 -y 1360 -defaultsOSRD
preplace inst encoder_0 -pg 1 -lvl 1 -x 420 -y 560 -defaultsOSRD
preplace inst equalizer_pilot_remo_0 -pg 1 -lvl 1 -x 420 -y 1200 -defaultsOSRD
preplace inst fft_top0_0 -pg 1 -lvl 1 -x 420 -y 1550 -defaultsOSRD
preplace inst fft_top1_0 -pg 1 -lvl 1 -x 420 -y 1690 -defaultsOSRD
preplace inst pilot_insertion_0 -pg 1 -lvl 1 -x 420 -y 1860 -defaultsOSRD
preplace inst pixl_to_symbol_0 -pg 1 -lvl 1 -x 420 -y 2020 -defaultsOSRD
preplace inst symbol_to_pixl_0 -pg 1 -lvl 1 -x 420 -y 2190 -defaultsOSRD
preplace inst QAM_1 -pg 1 -lvl 1 -x 420 -y 400 -defaultsOSRD
preplace netloc rst_ps8_0_99M_peripheral_aresetn 1 0 2 20 1280 570
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 2 30 1770 680
preplace netloc CP_insertion_0_data_out 1 1 1 700 90n
preplace netloc CP_removal_0_data_out 1 1 1 590 880n
preplace netloc QAM_0_data_out 1 1 1 690 250n
preplace netloc axi_dma_M_AXIS_MM2S 1 0 2 NJ 1940 660J
preplace netloc axis_switch_0_M01_AXIS 1 2 1 N 1010
preplace netloc axis_switch_M00_AXIS 1 0 3 80 2110 NJ 2110 1110
preplace netloc axis_switch_M02_AXIS 1 0 3 70 170 NJ 170 1040
preplace netloc axis_switch_M03_AXIS 1 0 3 40 480 NJ 480 1000
preplace netloc axis_switch_M04_AXIS 1 0 3 70 1440 NJ 1440 1040
preplace netloc axis_switch_M05_AXIS 1 0 3 30 0 NJ 0 1100
preplace netloc axis_switch_M06_AXIS 1 0 3 40 10 NJ 10 1090
preplace netloc axis_switch_M08_AXIS 1 0 3 80 800 NJ 800 1070
preplace netloc axis_switch_M09_AXIS 1 0 3 80 1120 570J 870 1060
preplace netloc axis_switch_M10_AXIS 1 0 3 80 960 600J 880 1050
preplace netloc axis_switch_M12_AXIS 1 0 3 80 1450 NJ 1450 1030
preplace netloc axis_switch_M13_AXIS 1 0 3 50 1460 NJ 1460 1020
preplace netloc axis_switch_M14_AXIS 1 0 3 60 1470 NJ 1470 1010
preplace netloc axis_switch_M15_AXIS 1 0 3 70 1780 NJ 1780 1000
preplace netloc channel_gen_0_data_out 1 1 1 610 720n
preplace netloc deQAM_0_data_out 1 1 1 580 1040n
preplace netloc decoder_0_data_out 1 1 1 630 1220n
preplace netloc encoder_0_data_out 1 1 1 680 560n
preplace netloc equalizer_pilot_remo_0_data_out 1 1 1 N 1200
preplace netloc fft_top0_0_data_out 1 1 1 600 1020n
preplace netloc fft_top1_0_data_out 1 1 1 650 1180n
preplace netloc pilot_insertion_0_data_out 1 1 1 620 980n
preplace netloc pixl_to_symbol_0_data_out 1 1 1 640 940n
preplace netloc ps8_0_axi_periph_M02_AXI 1 0 2 NJ 2100 700J
preplace netloc symbol_to_pixl_0_data_out 1 1 1 690 1240n
preplace netloc QAM_1_m_axis 1 1 1 670 400n
preplace netloc axis_switch_M07_AXIS 1 0 3 80 640 NJ 640 1080
levelinfo -pg 1 0 420 860 1130
pagesize -pg 1 -db -bbox -sgen -180 -10 1250 2270
"
}
  ...
  # Create instance: comm
  create_hier_cell_comm [current_bd_instance .] comm
...
Port;FD4A0000;FD4AFFFF;0|FPD;DPDMA;FD4C0000;FD4CFFFF;0|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;7FFFFFFF;1|DDR;DDR_HIGH;800000000;87FFFFFFF;1|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;0|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1}\
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_dma_M_AXIS_MM2S [get_bd_intf_pins axi_dma/M_AXIS_MM2S] [get_bd_intf_pins comm/S03_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_switch_0_M01_AXIS [get_bd_intf_pins axi_dma/S_AXIS_S2MM] [get_bd_intf_pins comm/M01_AXIS]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins comm/S_AXI_CTRL] [get_bd_intf_pins ps8_0_axi_periph/M02_AXI]
  ...
  connect_bd_net -net axi_dma_s2mm_introut [get_bd_pins axi_dma/s2mm_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_intc_irq [get_bd_pins axi_intc/irq] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_dma/axi_resetn] [get_bd_pins axi_intc/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins comm/s_axi_ctrl_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins axi_intc/intr] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_dma/m_axi_mm2s_aclk] [get_bd_pins axi_dma/m_axi_s2mm_aclk] [get_bd_pins axi_dma/s_axi_lite_aclk] [get_bd_pins axi_intc/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins comm/s_axi_ctrl_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  ...
  assign_bd_address -offset 0x80010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_intc/S_AXI/Reg] -force
  assign_bd_address -offset 0x80020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs comm/axis_switch/S_AXI_CTRL/Reg] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces axi_dma/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH]
  ...
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"0.490535",
   "Default View_TopLeft":"-10,-61",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace inst axi_dma -pg 1 -lvl 6 -x 2230 -y 450 -defaultsOSRD
preplace inst axi_intc -pg 1 -lvl 5 -x 1870 -y 410 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 2 -x 550 -y 400 -defaultsOSRD
preplace inst comm -pg 1 -lvl 5 -x 1870 -y 230 -defaultsOSRD
preplace inst ps8_0_axi_periph -pg 1 -lvl 4 -x 1520 -y 160 -defaultsOSRD
preplace inst rst_ps8_0_99M -pg 1 -lvl 1 -x 200 -y 820 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 4 -x 1520 -y 640 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 3 -x 1020 -y 90 -defaultsOSRD
preplace netloc axi_dma_mm2s_introut 1 3 4 1360 570 NJ 570 NJ 570 2420
preplace netloc axi_dma_s2mm_introut 1 3 4 1340 560 NJ 560 2030J 580 2410
preplace netloc axi_intc_irq 1 2 4 710 340 NJ 340 1680J 120 2010
preplace netloc rst_ps8_0_99M_peripheral_aresetn 1 1 5 390 290 NJ 290 1360 350 1730 320 2020J
preplace netloc xlconcat_0_dout 1 4 1 1700 440n
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 6 10 410 380 180 700 180 1340 360 1720 310 2030
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 0 4 20 490 NJ 490 NJ 490 1330
preplace netloc axi_dma_M_AXIS_MM2S 1 4 3 1730 100 NJ 100 2430
preplace netloc axi_dma_M_AXI_MM2S 1 1 6 410 310 700J 320 NJ 320 1670J 110 NJ 110 2420
preplace netloc axi_dma_M_AXI_S2MM 1 1 6 400 300 NJ 300 1350J 330 1690J 130 NJ 130 2410
preplace netloc axi_smc_M00_AXI 1 2 1 690 60n
preplace netloc axis_switch_0_M01_AXIS 1 5 1 2040 230n
preplace netloc ps8_0_axi_periph_M00_AXI 1 4 2 NJ 140 2050
preplace netloc ps8_0_axi_periph_M01_AXI 1 4 1 1710 160n
preplace netloc ps8_0_axi_periph_M02_AXI 1 4 1 1700 180n
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_LPD 1 3 1 N 60
levelinfo -pg 1 -10 200 550 1020 1520 1870 2230 2450
pagesize -pg 1 -db -bbox -sgen -10 0 2450 920
"
}
...
# End of cr_bd_commun()
cr_bd_commun ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files commun.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files commun.bd ] 
set_property IS_ENABLED "1" [get_files commun.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files commun.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files commun.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files commun.bd ] 
set_property PFM_NAME "" [get_files commun.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files commun.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files commun.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files commun.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files commun.bd ] 
set_property USED_IN_SIMULATION "1" [get_files commun.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files commun.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse commun.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/composable_communcation/composable_communcation.gen/sources_1/bd/commun/hdl/commun_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse commun.bd] -top]
...
set_property -name "auto_incremental_checkpoint.directory" -value "/mnt/HLSNAS/g110064539/composable_IP_file/composable_communcation/composable_communcation.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "/mnt/HLSNAS/g110064539/composable_IP_file/composable_communcation/composable_communcation.srcs/utils_1/imports/impl_1" -objects $obj
