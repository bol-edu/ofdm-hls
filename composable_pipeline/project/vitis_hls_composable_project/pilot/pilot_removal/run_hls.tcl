...
add_files "src/equalizer_pilot_removal.cpp"
add_files "src/equalizer_pilot_removal.h"
add_files "src/pilot_insertion.cpp"
add_files "src/pilot_insertion.h"
add_files "src/data_path.hpp"

add_files -tb "src/main.cpp" -cflags "-Wno-unknown-pragmas" -csimflags "-Wno-unknown-pragmas" 

set_top equalizer_pilot_removal
